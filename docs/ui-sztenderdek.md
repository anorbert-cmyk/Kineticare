...
| 24 | **Ugrás a rendelő elérhetőségeihez a szakember-szekcióból** | `Nézd meg az elérhetőségeinket` | E/2 (P-1b) | `secondary` | **Felirat cserélve (2026-08-17).** Korábban `Kérj időpontot üzenetben`. A tulajdonos döntése óta az időpontot TELEFONON egyeztetik, írásos időpontkérés tehát sehol nincs a felületen: a régi felirat olyat ígért, ami a kattintás után nem létezik (§3.1 „a felirat legyen igaz"). A kattintás a `/kapcsolat` időpontkérő szekciójára visz, ahol a rendelők címe, mindkét telefonszám és az e-mail-cím áll. A telefonálást kerülő látogatót az e-mail-cím és a lap alji üzenetküldő űrlap szolgálja ki (NN/g egészségügyi út-kutatás), csak nem időpontkérésnek álcázva. |
